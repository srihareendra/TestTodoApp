...
<script>
function newDoc() {
    window.location.assign("http://localhost:8080/TestGridView")
}
</script>
</head>
<body>
<s:form action="saveOrUpdateTask" validate="true">
	<s:push value="task">
		<s:hidden name="id" />
		...
		<s:textfield name="duedate" label="Due Date" required="true" />
		
		<s:submit />
	</s:push>
</s:form>
<input type="button" value="DatagridView" onclick="newDoc()">
